...
namespace Livraria.Infra.Repositories
{
    public class LivroRepository : ILivroRepository
    {
        ...
        public LivroRepository(MongoDataContext dataContext)
        {
        ...
        public void Inserir(Livro livro)
        {
            try
            {
                IMongoCollection<BsonDocument> insert = _dataContext.MongoDataContext_.GetCollection<BsonDocument>("Livro");
        ...
        public void Alterar(Livro livro)
        {
            try
            {
                IMongoCollection<LivroQueryResult> update = _dataContext.MongoDataContext_.GetCollection<LivroQueryResult>("Livro");
        ...
        public void Deletar(Guid id)
        {
            try
            {
                IMongoCollection<LivroQueryResult> delete = _dataContext.MongoDataContext_.GetCollection<LivroQueryResult>("Livro");
                Expression<Func<LivroQueryResult, bool>> filter = x => x.Id.Equals(id);
                DeleteResult result = delete.DeleteOne(filter);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public List<LivroQueryResult> Listar()
        {
            try
            {
                var collection = _dataContext.MongoDataContext_.GetCollection<LivroQueryResult>("Livro");
        ...
        public bool CheckId(Guid id)
        {
            try
            {
                IMongoCollection<LivroQueryResult> query = _dataContext.MongoDataContext_.GetCollection<LivroQueryResult>("Livro");
                Expression<Func<LivroQueryResult, bool>> filter = x => x.Id.Equals(id);
                IList<LivroQueryResult> usuario = query.Find(filter).ToList();
